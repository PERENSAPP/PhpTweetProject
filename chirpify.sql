...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 06 apr 2023 om 00:20
...
(58, 'admin', 'admin@gmail.com', '$2y$10$X03XC6yp31ZJrUGmNxKM2OIH2JZVdsPECiEkWdamKLIBKkDD2SZ.6', 1111),
...
(70, 'doe het plz', 'plzzzzzz', 2, 58, 'PP_SLAYER_TIFFANY'),
(72, 'Hi ik ben Savannah', '#rainbow', 2, 60, 'savannah'),
(73, 'pure pijn en drugs ', '', 2, 62, 'Floortje '),
(75, 'PP SLAYER NEVER DIES ', 'Dying is a skill issue ', 2, 58, 'PP_SLAYER_TIFFANY'),
(78, 'de fbi kan me niet censureren', 'CANT SILENTCE PP SLAYER TIFFANY ', 1, 58, 'PP_SLAYER_TIFFANY');
